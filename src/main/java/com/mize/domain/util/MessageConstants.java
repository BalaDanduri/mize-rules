...
public abstract class MessageConstants implements Serializable{
	...
	public static String INVALID_BRAND_NAME = "INVALID_BRAND_NAME";
	public static String INVALID_DATE_RANGE = "INVALID_DATE_RANGE";
	public static String BRAND_NAME_REQUIRED = "BRAND_NAME_REQUIRED";
