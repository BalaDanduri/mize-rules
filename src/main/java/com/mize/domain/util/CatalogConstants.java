...
public abstract class CatalogConstants implements Serializable{
	...
	public static final String FORM_FIELD_TYPES = "FormFieldTypes";
	public static final String SERVICE_TYPE = "LaborType";
	public static final String INSPECTION_TYPE = "InspectionType";
	public static final String USER_INSPECTION_TYPE ="UserInspectionType";
	...
	public static final String  SR_CUSTOMER_TYPE= "SRCustomerType";
	public static final String  SR_REQUESTER_TYPE= "SRRequesterType";
	public static final String  SR_STATUS= "SRStatus";
	public static final String  SR_SERVICE_TYPE= "SRServiceType";
	public static final String  SR_COMMENT_TYPE= "SRCommentType";
